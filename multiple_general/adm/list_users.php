...
while (list($vkGroupId)=mysqli_fetch_array($sql))
{
   ...
   $groupsList.= "<option value=\"{$vkGroupId}\">{$groupName[$vkGroupId]}";
...
{   
   ...
   $users_table.='<tr><td><a href="https://vk.com/id'.$user_info[0]['id'].'" target="_vk">'.$user_info[0]['first_name'].' '.$user_info[0]['last_name'].'</a></td>';   
