...
echo '<h1>Управление администраторами группы '.$_GET['vkGroupId'].'</h1>';
...
<div class="desc">
    ...
    {   
        ...
        echo '<tr><td><a href="https://vk.com/id'.$vkId.'" target="_vk">https://vk.com/id'.$vkId.'</a></td><td><select name="action['.$vkId.']">'.$action_list.'</select></td></tr>';
    }
