...
$users_table='<table border=0><tr><th>Подписчик</th><th>Группа</th><th>Действие</th><th>vkId</th><th>Диалог</th></tr>';
...
{   
   ...
   $users_table.='<td>'.$vkId.'</td><td><a href="../adm/?f=dialog&vkId='.$vkId.'&botId='.$vkGroupId.'" target="_dialog">Диалог с пользователем</a></td></tr>';
}  
