...
<p><input type="submit" value="Отправить"></p>
    ...
    if(isset($_GET['taskId']) AND !isset($_GET['copy']))
        echo "UPDATE `".DBP_GENERAL."message_tasks` SET dateTime='{$_POST['dateTime']}',ADM_VK_ID='".ADM_VK_ID."',DBP='".DBP."',dataJson='".mysqli_escape_string($dblink,json_encode($_POST))."' WHERE taskId={$_GET['taskId']}"; //mysqli_query($dblink,"UPDATE `".DBP_GENERAL."message_tasks` SET dateTime='{$_POST['dateTime']}',ADM_VK_ID='".ADM_VK_ID."',DBP='".DBP."',dataJson='".mysqli_escape_string($dblink,json_encode($_POST))."' WHERE taskId={$_GET['taskId']}");
    else
        echo "INSERT INTO `".DBP_GENERAL."message_tasks` (dateTime,ADM_VK_ID,DBP,dataJson) VALUES ('{$_POST['dateTime']}','".ADM_VK_ID."','".DBP."','".mysqli_escape_string($dblink,json_encode($_POST))."')"; //mysqli_query($dblink,"INSERT INTO `".DBP_GENERAL."message_tasks` (dateTime,ADM_VK_ID,DBP,dataJson) VALUES ('{$_POST['dateTime']}','".ADM_VK_ID."','".DBP."','".mysqli_escape_string($dblink,json_encode($_POST))."')");
